  ...
  return (
    <main className="vivid-stage">
      ...
      <header className="vivid-nav">
        ...
        <Link href="/#cases" className="vivid-home-btn">
          HOME ::
        </Link>
      </header>

      {/* SECTION 1: 50/50 SPLIT STAGE */}
      <div className="vivid-hero-split">
        ...
        <div className="vivid-hero-left">
          ...
          {/* Bottom Left Fixed Client Card (CLIENT / Client Name) */}
        ...
        <div className="vivid-hero-right">
          ...
          >
            ...
            {/* 3. BRAND CENTER OVERLAY: Iconic Logo & Name */}
      ...
      {/* SECTION 2: CASE STUDY DEEP DIVE SECTION */}
