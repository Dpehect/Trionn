  ...
  return <main>
    ...
    <section className="pb-32"><div className="container-shell grid gap-8 lg:grid-cols-[.72fr_1.28fr]">
      <aside className="space-y-5">
        <div className="rounded-[2rem] bg-ink p-8 text-white"><span className="eyebrow text-white/45">Direct contact</span><Link href={`mailto:${siteConfig.email}`} className="group mt-12 flex items-end justify-between gap-4 break-all text-2xl font-semibold tracking-[-.04em]">{siteConfig.email}<ArrowUpRight className="shrink-0 transition group-hover:rotate-45"/></Link></div>
        <div className="grid gap-4 rounded-[2rem] border hairline p-7 text-sm">
