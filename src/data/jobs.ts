...
export const jobs: Job[] = [
 ...
 {slug:'ai-automation-engineer',title:'AI Automation Engineer',discipline:'AI Systems',location:'Remote EU',type:'Contract / Full-time',summary:'Build dependable AI agents, workflow automations and human-in-the-loop systems.',responsibilities:['Implement LLM workflows and tool integrations','Evaluate reliability, latency and cost','Connect agents to real business systems'],requirements:['Python or TypeScript backend experience','Knowledge of LLM evaluation and retrieval','Security-minded integration experience']}
];
